...
namespace MarriageApp.API.Controllers
{
    ...
    public class MessagesController : ControllerBase
    {
        ...
        public MessagesController(IMarriageRepository repo, IMapper mapper)
        {
            _repo = repo;
            _mapper = mapper;
        }
        ...
        public async Task<IActionResult> CreateMessage(int userId, MessageForCreationDto messageForCreationDto)
        {
            ...
            var recipitent = await _repo.GetUser(messageForCreationDto.RecipientId);
            if(recipitent == null)
            return BadRequest("Recipitent not found");
            ...
            throw new Exception("Failed on saving");
